...
const Schema: z.ZodType<Prisma.UserHarvestParticipationsUncheckedUpdateManyInput> =
  z
    .object({
      id: z
        .union([
...
export const UserHarvestParticipationsUncheckedUpdateManyInputObjectSchema =
  Schema;
