...
const Schema: z.ZodType<Prisma.UserHarvestParticipationsUncheckedUpdateWithoutUserInput> =
  z
    .object({
      id: z
        .union([
...
export const UserHarvestParticipationsUncheckedUpdateWithoutUserInputObjectSchema =
  Schema;
