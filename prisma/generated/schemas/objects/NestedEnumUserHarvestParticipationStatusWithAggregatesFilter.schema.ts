...
const Schema: z.ZodType<Prisma.NestedEnumUserHarvestParticipationStatusWithAggregatesFilter> =
  z
    .object({
...
export const NestedEnumUserHarvestParticipationStatusWithAggregatesFilterObjectSchema =
  Schema;
