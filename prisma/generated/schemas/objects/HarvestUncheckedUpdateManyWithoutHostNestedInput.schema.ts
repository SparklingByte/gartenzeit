...
const Schema: z.ZodType<Prisma.HarvestUncheckedUpdateManyWithoutHostNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => HarvestUpsertWithWhereUniqueWithoutHostInputObjectSchema,
          ),
          z
            .lazy(
              () => HarvestUpsertWithWhereUniqueWithoutHostInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => HarvestUpdateWithWhereUniqueWithoutHostInputObjectSchema,
          ),
          z
            .lazy(
              () => HarvestUpdateWithWhereUniqueWithoutHostInputObjectSchema,
...
export const HarvestUncheckedUpdateManyWithoutHostNestedInputObjectSchema =
  Schema;
