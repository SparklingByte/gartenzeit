...
const Schema: z.ZodType<Prisma.UserHarvestParticipationsUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const UserHarvestParticipationsUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
