...
const Schema: z.ZodType<Prisma.UserHarvestParticipationsUpdateManyMutationInput> =
  z
    .object({
      id: z
        .union([
...
export const UserHarvestParticipationsUpdateManyMutationInputObjectSchema =
  Schema;
