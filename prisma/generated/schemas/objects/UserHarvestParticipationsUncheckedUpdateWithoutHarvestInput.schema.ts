...
const Schema: z.ZodType<Prisma.UserHarvestParticipationsUncheckedUpdateWithoutHarvestInput> =
  z
    .object({
      id: z
        .union([
...
export const UserHarvestParticipationsUncheckedUpdateWithoutHarvestInputObjectSchema =
  Schema;
