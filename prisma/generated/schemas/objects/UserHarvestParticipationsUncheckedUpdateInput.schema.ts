...
const Schema: z.ZodType<Prisma.UserHarvestParticipationsUncheckedUpdateInput> =
  z
    .object({
      id: z
        .union([
...
export const UserHarvestParticipationsUncheckedUpdateInputObjectSchema = Schema;
