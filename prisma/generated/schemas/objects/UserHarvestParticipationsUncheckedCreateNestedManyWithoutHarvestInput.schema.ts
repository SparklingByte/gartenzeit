...
const Schema: z.ZodType<Prisma.UserHarvestParticipationsUncheckedCreateNestedManyWithoutHarvestInput> =
  z
    .object({
      create: z
        .union([
...
export const UserHarvestParticipationsUncheckedCreateNestedManyWithoutHarvestInputObjectSchema =
  Schema;
