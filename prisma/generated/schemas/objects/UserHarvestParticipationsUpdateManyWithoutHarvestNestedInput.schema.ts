...
const Schema: z.ZodType<Prisma.UserHarvestParticipationsUpdateManyWithoutHarvestNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserHarvestParticipationsUpdateManyWithoutHarvestNestedInputObjectSchema =
  Schema;
