...
const Schema: z.ZodType<Prisma.UserHarvestParticipationsUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserHarvestParticipationsUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
